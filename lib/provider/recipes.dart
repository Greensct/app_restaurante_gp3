...
class Recipes with ChangeNotifier {
  List<Recipe> _products = [
    ...
    Recipe(
        ...
        brand: 'Nike',
        productCategoryName: 'Plato Fuerte',
        quantity: 65489,
        isPopular: false),
    Recipe(
    ...
    Recipe(
        ...
        description:
            'YAMAY Smart Watch 2020 Ver. Watches for Men Women Fitness Tracker Blood Pressure Monitor Blood Oxygen Meter Heart Rate Monitor IP68 Waterproof, Smartwatch Compatible with iPhone Samsung Android Entradas',
        price: 183.99,
        imageUrl:
  ...
  List<Recipe> get products {
    return [..._products];
  }

  List<Recipe> get popularProducts {
    return _products.where((element) => element.isPopular).toList();
  }

  Recipe findById(String productId) {
